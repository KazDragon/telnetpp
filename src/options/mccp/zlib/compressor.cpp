...
struct compressor::impl
{
    ...
    // COMPRESS
    // ======================================================================
    telnetpp::u8stream compress(telnetpp::u8stream const &sequence)
    {
        if (!compression_started_)
        {
            auto result = deflateInit(&stream_, Z_DEFAULT_COMPRESSION);
        ...
        do
        {
            telnetpp::u8 output_buffer[output_buffer_size];
    ...
    // END_COMPRESSION
    // ======================================================================
    telnetpp::u8stream end_compression()
    {
        telnetpp::u8 input_buffer[1] = {};
        telnetpp::u8 output_buffer[output_buffer_size];
