...
void server_option_test::deactivated_negotiate_do_responds_with_wont_no_signal()
{
    ...
    expect_tokens(
        { telnetpp::token(telnetpp::negotiation(telnetpp::wont, 0xA5)) },
...
void server_option_test::deactivated_activate_responds_with_will_no_signal()
{
    ...
    expect_tokens(
        { telnetpp::token(telnetpp::negotiation(telnetpp::will, 0xA5)) },
        server.activate());
...
void server_option_test::activatable_deactivated_negotiate_will_responds_with_do_with_signal()
{
    fake_server_option server(0xA5);
...
void server_option_test::activatable_deactivated_negotiate_wont_responds_with_dont_no_signal()
{
    fake_server_option server(0xA5);
    server.set_activatable();
