...
namespace {
using a_new_environ_client =
    a_telnet_option<telnetpp::options::new_environ::client>;
}
...
TEST_F(
    an_active_new_environ_client, requesting_no_variables_requests_empty_list)
{
...
TEST_F(
    an_active_new_environ_client,
    requesting_one_var_variable_requests_user_variable)
{
    static telnetpp::options::new_environ::request const requests[] = {
        telnetpp::options::new_environ::request{
                                                telnetpp::options::new_environ::variable_type::var, "TEST"_tb}
    };
...
TEST_F(
    an_active_new_environ_client,
    requesting_one_user_variable_requests_user_variable)
{
    static telnetpp::options::new_environ::request const requests[] = {
        telnetpp::options::new_environ::request{
                                                telnetpp::options::new_environ::variable_type::uservar, "TEST"_tb}
    };
...
TEST_F(
    an_active_new_environ_client,
    requesting_two_variables_requests_two_variables)
{
    static telnetpp::options::new_environ::request const requests[] = {
        telnetpp::options::new_environ::request{
                                                telnetpp::options::new_environ::variable_type::var,     "TEST0"_tb},
...
TEST_F(
    an_active_new_environ_client, requesting_var_with_value_in_name_is_escaped)
{
    static telnetpp::options::new_environ::request const requests[] = {
        telnetpp::options::new_environ::request{
                                                telnetpp::options::new_environ::variable_type::var,
...
TEST_F(
    an_active_new_environ_client,
    requesting_var_with_uservar_in_name_is_escaped)
{
    static telnetpp::options::new_environ::request const requests[] = {
        telnetpp::options::new_environ::request{
                                                telnetpp::options::new_environ::variable_type::var,
...
TEST_F(
    an_active_new_environ_client,
    receiving_var_and_no_value_reports_undefined_var)
{
    ...
    ASSERT_EQ(
        telnetpp::options::new_environ::variable_type::var, responses_[0].type);
...
TEST_F(
    an_active_new_environ_client,
    receiving_uservar_and_no_value_reports_undefined_uservar)
{
    static auto const subnegotiation_content =
        "\x00"  // IS
        "\x03"
        "TEST"_tb;  // USERVAR TEST
...
TEST_F(
    an_active_new_environ_client,
    receiving_var_and_empty_value_reports_empty_var)
{
    static auto const subnegotiation_content =
        "\x00"  // IS
        "\x00"
...
TEST_F(
    an_active_new_environ_client,
    receiving_uservar_and_empty_value_reports_empty_var)
{
    static auto const subnegotiation_content =
        "\x00"  // IS
        "\x03"
...
TEST_F(
    an_active_new_environ_client, receiving_var_and_value_reports_var_and_value)
{
    static auto const subnegotiation_content =
        "\x00"
        "\x00"
...
TEST_F(
    an_active_new_environ_client,
    receiving_uservar_and_value_reports_var_and_value)
{
    static auto const subnegotiation_content =
        "\x00"
        "\x03"
...
TEST_F(
    an_active_new_environ_client,
    receiving_multiple_variables_reports_multiple_variables)
{
    static auto const subnegotiation_content =
        "\x00"
        "\x00"
...
TEST_F(
    an_active_new_environ_client,
    receiving_info_for_multiple_variables_reports_multiple_variables)
{
    static auto const subnegotiation_content =
        "\x02"
        "\x00"
...
TEST_F(
    an_active_new_environ_client,
    receiving_uservar_with_escaped_var_in_name_reports_variable_correctly)
{
    static auto const subnegotiation_content =
        "\x00"
        "\x03"
...
TEST_F(
    an_active_new_environ_client,
    receiving_uservar_with_escaped_uservar_in_name_reports_variable_correctly)
{
    static auto const subnegotiation_content =
        "\x00"
        "\x03"
...
TEST_F(
    an_active_new_environ_client,
    receiving_uservar_with_escaped_value_in_name_reports_variable_correctly)
{
    static auto const subnegotiation_content =
        "\x00"
        "\x03"
...
TEST_F(
    an_active_new_environ_client,
    receiving_uservar_with_escaped_escape_in_name_reports_variable_correctly)
{
    static auto const subnegotiation_content =
        "\x00"
        "\x03"
...
TEST_F(
    an_active_new_environ_client,
    receiving_uservar_with_escaped_var_in_value_reports_variable_correctly)
{
    static auto const subnegotiation_content =
        "\x00"
        "\x03"
...
TEST_F(
    an_active_new_environ_client,
    receiving_uservar_with_escaped_uservar_in_value_reports_variable_correctly)
{
    static auto const subnegotiation_content =
        "\x00"
        "\x03"
