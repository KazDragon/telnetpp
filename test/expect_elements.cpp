...
{
public :
    explicit elements_match(telnetpp::element const &expected)
      : expected_(expected)
    {
    }
...
{
    explicit tokens_match(telnetpp::token const &expected)
      : expected_(expected)
    {
    }
...
{
    explicit stream_tokens_match(telnetpp::stream_token const &expected)
      : expected_(expected)
    {
    }
