...
namespace {
using a_new_environ_server =
    a_telnet_option<telnetpp::options::new_environ::server>;
}
...
TEST_F(
    an_active_new_environ_server,
    receiving_request_with_no_content_and_no_cached_variables_sends_empty_list)
{
...
TEST_F(
    an_active_new_environ_server,
    receiving_request_with_no_content_and_one_cached_variable_sends_variable)
{
...
TEST_F(
    an_active_new_environ_server,
    receiving_request_with_no_content_and_one_cached_user_variable_sends_all_variables)
{
    static auto const name = "USER"_tb;
    static auto const value = "TEST"_tb;
...
TEST_F(
    an_active_new_environ_server,
    receiving_request_with_no_content_and_one_cached_variable_with_empty_value_sends_all_variables)
{
    static auto const name = "USER"_tb;
...
TEST_F(
    an_active_new_environ_server,
    receiving_request_with_no_content_and_one_deleted_variable_sends_no_variables)
{
    static auto const name = "USER"_tb;
    static auto const value = "TEST"_tb;
...
TEST_F(
    an_active_new_environ_server,
    receiving_request_with_no_content_and_one_deleted_uservariable_sends_no_variables)
{
...
TEST_F(
    an_active_new_environ_server,
    receiving_request_with_no_content_and_multiple_cached_variables_sends_all_variables)
{
...
TEST_F(
    an_active_new_environ_server,
    modifying_a_variable_sends_variable_modification)
{
    static auto const name = "USER"_tb;
...
TEST_F(
    an_active_new_environ_server, deleting_a_variable_sends_variable_deletion)
{
    static auto const name = "USER"_tb;
...
TEST_F(
    an_active_new_environ_server,
    modifying_a_user_variable_sends_variable_modification)
{
...
TEST_F(
    an_active_new_environ_server,
    deleting_a_user_variable_sends_variable_deletion)
{
    static auto const name = "TEST"_tb;
...
TEST_F(
    an_active_new_environ_server,
    requesting_nonexistent_variable_returns_empty_result)
{
    static auto const name = "TEST"_tb;
    static auto const value = "VALUE"_tb;
...
TEST_F(
    an_active_new_environ_server, requesting_existent_variables_sends_variables)
{
    static auto const name0 = "PRINTER"_tb;
    static auto const value0 = "LPT1"_tb;
    static auto const name1 = "USER"_tb;
...
TEST_F(
    an_active_new_environ_server,
    names_and_values_with_control_characters_are_escaped_properly)
{
    static auto const name0 = "USER"_tb;
    static auto const value0 =
        "\x01"
        "ABC"_tb;
    static auto const name1 =
        "\x00"
        "DEF"_tb;
    static auto const value1 =
        "\x02"
        "GHI"_tb;
...
TEST_F(
    an_active_new_environ_server,
    requests_with_escaped_control_characters_are_handled_correctly)
{
